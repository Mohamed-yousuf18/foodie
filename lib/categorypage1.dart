          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                InkWell(
                    onTap: (){
                       Navigator.of(context).push(MaterialPageRoute(builder: (_) => CategoryPage2()));
                      },
              ...
              return GridView.builder(
                ...
                itemBuilder: (BuildContext context,int index){
                  return Transform.translate(
                    offset: index.isEven ? Offset(0, 30) : Offset(0, -15),
                    child: Container(
                                    ...
                                    children: [
                                      InkWell(
                                        onTap: (){
                                          ...
                                          child: Image.asset("${card[index].image}.png",scale: 1,)),
                                    ],
                                  ),
